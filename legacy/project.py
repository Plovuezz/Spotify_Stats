...
def main():
    ...
    while True:
        ...
        if choice == 'songs':
            ...
            print(
                'Wrong input, please try smth from these (songs, artists, genres, exit)',
                end='\n\n',
            )
...
def get_songs(sp):
    ...
    quantity = prompt_user(
        'How many songs do you want to see (1-50): ',
    ...
    term = prompt_user(
        'For what time period? (short - month, medium - 6 month, long - all time): ',
    ...
    # Displaing songs
    print('\n\n')
    print(f'Top {quantity} songs for the last {term.replace("_term", "")} term:\n')
...
def get_artists(sp):
    ...
    quantity = prompt_user(
        'How many artists do you want to see (1-50): ',
        retry_prompt='Please type a valid number from 1 to 50: ',
        numbers_range=[1, 50],
    )
    ...
    # Displaing artists
    print('\n\n')
    print(f'Top {quantity} artists for the last {term.replace("_term", "")} term:\n')
...
def get_genres(sp):
    ...
    quantity = prompt_user(
        'How many genres do you want to see (1-20): ',
    ...
    # Displaying genres
    print(end='\n\n')
    print(f'Top {quantity} genres for the last {term.replace("_term", "")} term:\n')
    ...
    if want_playlist:
        ...
        for i in range(10):
            if results2['playlists']['items'][i] is not None:
                print(
                    f'{results2["playlists"]["items"][i]["external_urls"]["spotify"]} - '
